...
import dagshub
import matplotlib
matplotlib.use('Agg')  # Use non-interactive backend for matplotlib to avoid display issues
...
mlflow.set_experiment("Experiment 4(hyperparameter tuning on RF)")  # Name of the experiment in MLflow
...
data = pd.read_csv("c:/Users/varun/OneDrive/Documents/Water Potability Prediction Using ML and MLFlow/water_potability.csv")
